...
<div class="app">
                    ...
                    <div  class="header__cart-swap">               
                        <i class=" header__cart-icon fa-sharp fas fa-cart-shopping"></i>
                                <?php
                                    ...
                                    if(isset($_SESSION['cart'])){                
                                       foreach($_SESSION['cart'] as $k=>$v){
                                        ...
                                        // print_r($_SESSION['cart'][$customer_id]);
                                        // if(isset($_SESSION['cart'][$customer_id])){                 
                                        //     foreach($_SESSION['cart'][$customer_id] as $k=>$v){
                                            if(isset($v)){
                                            $ok=2;
                                            }
                                        }
                                ...
                                <span class="header__cart-swap-notice">0</span>
                                    ...
                                    // foreach($_SESSION['cart'][$customer_id] as $key=>$value){
                                    $item[]=$key;
                                    }
                                    $str=implode(",",$item);
                                            ...
                                            <li class="header__cart-item">
                                                ...
                                                <div class="header__cart-item-info">
                                                            ...
                                                            <div class="header__cart-item-body">
                                                               ...
                                                               <a href="/Controller/xoagiohang.php?productid=<?php echo $row['id']?>"  class="header__cart-item-remove">Xóa</a>
    ...
    if(isset($_SESSION['address-infor'])){
        // foreach ($_SESSION['address-infor'] as $addressInfor ){
            $addressInfor = $_SESSION['address-infor'];
            // var_dump($_SESSION['address-infor']);
            // var_dump($addressInfor);
   ...
   <div class="app__container">
        <div class="address__container">
            <div class="address__content">
                <div class="address__content__header">
                    <span class="address__content__header--title">Địa chỉ của tôi</span>
                    <span id="add-address" class="address__content__header--addInfor" >Thêm địa chỉ mới</span>
                </div>
                <div class="address__content__body">
                    <div class="address__content__body--infor">
                    <span class="address__content__body--name"><?php echo $addressInfor['fullName']?></span> 
                    <span class="address__content__body--phoneNumber"><?php echo $addressInfor['phoneNumber']?></span> 
                    <span class="address__content__body--address"><?php echo $addressInfor['yourAddress']?></span>
                </div>
                    <a href="/Controller/xoadiachi.php" class="address__content__body--del">Xóa</a>
            </div>
        </div>
    </div>
      <?php
      ...
      <div class="app__container">
        <div class="address__container">
            ...
            <div class="address__content__header">
                    <span class="address__content__header--title">Địa chỉ của tôi</span>
                    <span class="address__content__header--addInfor" id="add-address">Thêm địa chỉ mới</span>
                </div>
            </div>
        </div>
    </div>
      ...
      ?>   
      <!-- form địa chỉ -->
      <form class="show__form__address" id="address-Id" action="/Controller/xulyFormdiachi.php" method="POST">
        <div class="form__address--overlay" id="overlay"></div>
            <div class="container__form-address">
                <div class="content__form-address">
                    <h1 class="content__form-address--title">Địa chỉ mới</h1>
                    ...
                    <div class="content__form-address--button">
                        <a href="/View/diachi.php" id="address__back--btn" class=" btn content__form-address__button--return">Trở Lại</a>
