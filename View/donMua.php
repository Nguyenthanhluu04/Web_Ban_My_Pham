...
<div class="app__container">
    <div class="address__container">
        ...
        <div class="customer__container">
					<h1 class="customer__title"> Đơn Hàng Của Tôi</h1>
                    ...
                    <td class="customer__table--item" >Status</td>
					</tr>
					<?php
					 $conn = mysqli_connect("localhost","root","","MYPHAM");
					 $sql = " SELECT * FROM  xacnhandonhang WHERE userId =" . $customer_id;
					 $result = mysqli_query($conn,$sql);
					 while($row = mysqli_fetch_array($result)){
					?>	
               <tr class="customer__table--body">
				...
				<td  class="colorSuccess customer__table--body-item " ><?php echo $row['actions']?></td>
				<td  class="colorSuccess customer__table--body-item " >
                <a href="/Controller/xacnhandonhang.php?iddh=<?php echo $row['id']?>" class="customer__table--body-btn-received ">Đã Nhận</a>
