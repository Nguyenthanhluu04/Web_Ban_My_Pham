		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">ADMIN-SHOP</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="/View_Admin/khosanpham.php">
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<div class="customer__container">
					<h1 class="customer__title">Quản Lý Đơn Hàng </h1>
					...
					<td class="customer__table--item" >CustomerName</td>
					<td class="customer__table--item" >PhoneNumber</td>
					<td class="customer__table--item" >YourAddress</td>
					<td class="customer__table--item" >Img</td>
					<td class="customer__table--item" >ProductName</td>
                    <td class="customer__table--item" >Quantity</td>
					<td class="customer__table--item" >Price</td>
					<td class="customer__table--item" >Action</td>
					</tr>
					<?php
					 }else if($row = mysqli_fetch_array($result)<=0){
						?>
						<div class="admin_no-order">
						<img src="/assets/img/no_cart.png" alt="no-cart-img" class=" admin_no-order-img">
						<span class=" admin_no-order-text">Chưa Có Đơn Đặt Hàng</span>
						</div>
						<?php
					}
					?>
					...
					?>	
					<form action="/Controller_Admin/xulyadminDuyetDonhang.php" method="POST">
             <tr class="customer__table--body">
                <td  class="customer__table--body-item" ><?php echo $row['customerName']?></td>
				<input type="hidden" name="customerName" value="<?php echo $row['customerName']?>">
                <td  class="customer__table--body-item" ><?php echo $row['phoneNumber']?></td>
                <td  class="customer__table--body-item input__big" ><?php echo $row['yourAddress']?></td>
                <td  class="customer__table--body-item " >
                 <div class="customer__table--body-item__img" style="background-image:url(<?php echo $row['img']?>);" ></div>
				 <input type="hidden" name="img" value="<?php echo $row['img']?>">
                </td>
                <td  class="customer__table--body-item input__big" ><?php echo $row['productName']?></td>
				<input type="hidden" name="productName" value="<?php echo $row['productName']?>">
                <td  class="customer__table--body-item" ><?php echo $row['quantity']?></td>
				<input type="hidden" name="quantity" value="<?php echo $row['quantity']?>">
                <td  class="customer__table--body-item" ><?php echo $row['totalAmount']?></td>
				<input type="hidden" name="totalAmount" value="<?php echo $row['totalAmount']?>">
				<input type="hidden" name="userId" value="<?php echo $row['userId']?>">
				<input type="hidden" name="action" value="Đã Xác Nhận">
				<input type="hidden" name="status" value="Đang Giao">
				<td  class="customer__table--body-item" > 
					<input class="customer__table--body-btn-successs" type="submit" value="Duyệt">
					<a href="/Controller_Admin/xoadonhang.php?iddh=<?php echo $row['id']?>" class="customer__table--body-btn-del">Xóa</a>
