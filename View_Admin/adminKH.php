				...
				<div class="customer__container">
					...
					<tr class="customer__table--body">
						...
						<td  class="customer__table--body-item" > 
							<a  href="/Controller_Admin/xulySuaKH.php?idkh=<?php echo $row['id']?>" class="customer__table--body-btn-upd" >Sửa</a>
							<a href="/Controller_Admin/xulyXoaKH.php?idkh=<?php echo $row['id']?>" class="customer__table--body-btn-del">Xóa</a>
						</td>
					</tr>
                     <?php
					 }
