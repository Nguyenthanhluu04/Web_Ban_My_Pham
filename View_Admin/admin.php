					...
					<div class="navbar-collapse collapse">
						 <div class="navbar-nav navbar-align">
							...
							?>
								...
								<img src="https://png.pngtree.com/png-vector/20191122/ourlarge/pngtree-beautiful-admin-roles-glyph-vector-icon-png-image_2002847.jpg"
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<div class="mb-0">
													<span class="text-muted">Đã bán trong tháng</span>
												</div>
											</div>
										</div>
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3">912</h1>
												<div class="mb-0">
													<span class="text-muted">Ghé thăm trong tháng</span>
												</div>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3">12.000$</h1>
												<div class="mb-0">
													<span class="text-muted">Thu nhập trong tháng</span>
												</div>
											</div>
										</div>
										<div class="card">
